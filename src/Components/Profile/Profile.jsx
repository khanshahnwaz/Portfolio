...
const Profile = () => {
  ...
  return (
    <div className='mx-auto w-full grid gap-y-4'>

        <img className='mx-auto md:h-52 rounded-full border-2 border-[#200971]' alt='Profile_Photo' src={profile_photo} loading='lazy'></img>
